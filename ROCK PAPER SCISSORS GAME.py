...
# STEP 3: CREATION OF WHILE LOOP TO ENABLE THE PLAYER TO PLAY THE GAME N NUMBER OF TIMES
...
###Prompting the user aking if he/she wants to play again
        play_again=str(input("Do you want to play again?type y for yes and n for no"))
        if(play_again!='y'):
            break
